...
object WindowsTab : Tab {
    ...
    override val options: TabOptions
        @Composable
        get() {
            val title = stringResource(R.string.windows)
            val icon = painterResource(R.drawable.ic_windows_logo)
    ...
    override fun Content() {
        Navigator(AppsScreen(VkpAppType.WINDOWS)) { navigator ->
