...
import com.jetbrains.kmpapp.data.remote.mappers.AppsMapper.buildsToDomain
...
class AppsRepository(
    ...
    override suspend fun getBuildsByAppId(appId: Long): Result<List<VkpBuild>> =
        appsApi.getBuildsByAppId(appId.toString()).map { it?.list.orEmpty().buildsToDomain() }
}