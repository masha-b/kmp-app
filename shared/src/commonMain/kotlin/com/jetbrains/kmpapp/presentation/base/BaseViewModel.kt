 ...
 *
 * @param State A class that inherits from [com.jetbrains.kmpapp.presentation.base.Reducer.ViewState]
 * @param Event A class that inherits from [com.jetbrains.kmpapp.presentation.base.Reducer.ViewEvent]
 * @param Effect A class that inherits from [com.jetbrains.kmpapp.presentation.base.Reducer.ViewEffect]
...
abstract class BaseViewModel<State : Reducer.ViewState, Event : Reducer.ViewEvent, Effect : Reducer.ViewEffect>(
    ...
    fun sendEventForEffect(event: Event, effect: Effect) {
